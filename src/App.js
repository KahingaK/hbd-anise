...
function App() {
  return (
    ...
    <div className="decorationsThree"></div>
      ...
      <div className=" absolute w-[150px] h-[5px] left-[53px] top-[100px]">
        <img alt="" src={cake}/>
      ...
      <h3 className="toyou"></h3>  
        ...
        <p> I hope your day is filled with lots of love and laughter! Even though we don't always see eye 2 eye, know that i'm here, cheering you on and sending lots of love your way! May all of your wishes come true.</p>
        <p className="name font-dancing">bro</p>
        </div>
      </div>
    </div>
  );
